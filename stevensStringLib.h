 ...
 * stevensStringLib.h
 *
 * Defines the stevensStringLib.h class, a class object meant to provide useful functions to expand interactions with the standard string type.
 */
#include<vector>
#include<string>
#include<sstream>
...
class stevensStringLib
{
    public:
         ...
         * 
         * Parameters:
         *  std::string input - The string we are examining to see if it contains the substring.
         *  std::string substring - The substring we are trying to see if it is contained in the input string.
         * 
         *  Returns:
         ...
         * 
         * Parameters:
         *  std::string input - The string we intend to separate with this function.
         *  std::string separator - The substring of the input string we intend to separate it by.
         *  bool omitEmptyStrings - If true, do not include empty strings in the returned vector. TODO!!!!
         * 
         * Returns:
         ...
         * 
         * Parameter:
         *  std::string inpt - The string we want to capitalize the first letter of.
         * 
         * Returns:
        ...
        /*
			...
			***Uses isdigit function from cctype library***
			input:
				string userInput - a string of input received by the cin stream
			output:
